...
const timezoneOptions = [...new Set(["Asia/Colombo", ...supportedTimezones])].map((timezone) => {
  const offset = new Intl.DateTimeFormat("en", { timeZone: timezone, timeZoneName: "longOffset" }).formatToParts(new Date()).find((part) => part.type === "timeZoneName")?.value;
